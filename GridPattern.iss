...
#define ApplicationName "GridPattern v1.1"

AppName    = GridPattern v1.1
AppVersion = 1.1
...
OutputBaseFilename = GridPattern v1.1
...
#define outFiles[0] "experts\GridPattern v1.1.mq4"
#define outFiles[1] "experts\GridPattern v1.1.ex4"
